            ...
            {applications.map((item, i) => (
              <motion.article
                ...
                className={`
                  ...
                  ${item.size === "large" ? "h-[420px]" : "h-[300px]"}
                `}
              >
                {/* IMAGE */}
                <img
                ...
                <div className="relative z-10 h-full flex flex-col justify-end p-10">
                  ...
                  {/* SUBTLE CTA */}
                  <div className="mt-6 inline-flex items-center gap-2 text-lime-400 text-xs uppercase tracking-widest font-semibold opacity-90">
                    View Application
                    <i
                      className="
                        fa-solid fa-arrow-right
