...
const SingleProduct = () => {
  ...
  const [openItem, setOpenItem] = useState(null); // click-open
  const [hoverItem, setHoverItem] = useState(null); // hover-preview
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-14">
            {product.usage.map((item) => (
              ...
              >
                ...
                <i
                  className={`
                    fa-solid ${usageIcons[item] || "fa-check"}
            ...
            >
              ...
              {(hoverItem === "finish" || openItem === "finish") && (
                <div className="px-8 pb-8 flex flex-wrap gap-3">
                  {product.finishesAvailable?.map((finish) => (
                    <span
                      key={finish}
