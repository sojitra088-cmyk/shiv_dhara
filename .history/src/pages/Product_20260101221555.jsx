...
<section className="pt-32 pb-32 bg-white">
  <div className="max-w-7xl mx-auto px-6">
    ...
    {/* GRID */}
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 auto-rows-[100px]">

      {/* LEFT COLUMN (2 BIG IMAGES = 300px) */}
      <div className="row-span-3 grid grid-rows-2 gap-10">
        {/* BIG 1 */}
      ...
      {/* RIGHT COLUMN (3 SMALL IMAGES = 300px) */}
      <div className="row-span-3 grid grid-rows-3 gap-10">
        {[
