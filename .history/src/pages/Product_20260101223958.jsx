        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="mt-6 text-gray-600 leading-relaxed max-w-xl">
              ...
              chosen for quality, finish, and architectural suitability.
            </p>
          </motion.div>
          ...
          >
            {featuredProducts.map((product, i) => (
              ...
              >
                ...
                <div className="p-6">
                  {/* CATEGORY */}
                  <p className="text-lime-600 text-[11px] uppercase tracking-widest font-bold mb-2">
                    {product.category}
                  </p>
                  ...
                  <p className="text-gray-500 text-sm mb-5">
                    Finish: <span className="font-medium text-gray-700">{product.finish}</span>
                  </p>

                  {/* CTA */}
                  <div className="inline-flex items-center gap-2 text-lime-600 font-semibold text-xs uppercase tracking-wider">
                    View Details
                    <span
                      className="
                        inline-block
