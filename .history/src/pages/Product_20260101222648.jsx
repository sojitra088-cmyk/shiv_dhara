      ...
      <section className="pt-32 pb-32 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* 01 */}
            <ApplicationCard {...applications[0]} />

            {/* 02 */}
            <ApplicationCard {...applications[1]} />

            {/* 03 */}
            <ApplicationCard {...applications[2]} />

            {/* 04 (SPAN 2) */}
            <ApplicationCard {...applications[3]} span={2} />

            {/* 05 */}
            <ApplicationCard {...applications[4]} />

            {/* 06 */}
            <ApplicationCard {...applications[0]} />

            {/* 07 (SPAN 2) */}
            <ApplicationCard {...applications[1]} span={2} />
